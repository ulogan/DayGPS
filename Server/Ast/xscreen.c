/*
** Astrolog (Version 5.05) File: xscreen.c
**
...
void BeginX()
{
...
#ifdef WIN
  if (wi.fChartWindow &&
    (wi.cxClient != gs.xWin || wi.cyClient != gs.yWin))
    ResizeWindowToChart();
  gi.xOffset = MulDiv(wi.cxClient - gs.xWin, wi.xScroll, nScrollDiv);
  gi.yOffset = MulDiv(wi.cyClient - gs.yWin, wi.yScroll, nScrollDiv);
  ...
  if (!gs.fJetTrail)
    PatBlt(wi.hdc, -gi.xOffset, -gi.yOffset, wi.cxClient, wi.cyClient,
