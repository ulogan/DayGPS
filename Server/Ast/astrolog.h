/*
** Astrolog (Version 5.05) File: astrolog.h
**
...
/*#define MOUSE /* Comment out this #define if you don't have a mouse, or    */
              ...
              /* is only an option if X11, WIN, MSG, or BGI above are set. */
...
#define MAXINDAY 250   /* Max number of aspects or transits displayable.   */
...
#define chH    (char)(us.fAnsi ? 196 : '-')  /* Ansi and Ascii characters  */
#define chV    (char)(us.fAnsi ? 179 : '|')  /* used to print text charts. */
#define chC    (char)(us.fAnsi ? 197 : '|')
#define chNW   (char)(us.fAnsi ? 218 : '+')
#define chNE   (char)(us.fAnsi ? 191 : '+')
#define chSW   (char)(us.fAnsi ? 192 : '+')
#define chSE   (char)(us.fAnsi ? 217 : '+')
#define chJN   (char)(us.fAnsi ? 193 : '-')
#define chJS   (char)(us.fAnsi ? 194 : '-')
#define chJW   (char)(us.fAnsi ? 180 : '|')
#define chJE   (char)(us.fAnsi ? 195 : '|')
#define chDeg0 (char)(us.fAnsi ? 248 : ' ')
#define chDeg1 (char)(us.fAnsi ? 248 : ':')
...
#ifdef MAC
#ifdef ISG
"If 'MAC' is defined 'X11', 'WIN', 'MSG', or 'BGI' must not be as well"
#endif
#ifdef SWITCHES
...
#ifdef GRAPH
#ifndef ISG
"If 'MOUSE' is defined 'X11', 'WIN', 'MSG', or 'BGI' must be too"
#endif
#endif /* GRAPH */
#endif /* MOUSE */
...
#define szVersionCore "5.05"
#define szDateCore    "August 1995"
#define szAddressCore "astara@u.washington.edu"
...
#define gHorizon    4
#define gOrbit      5
#define gAstroGraph 6
#define gEphemeris  7
#define gWorldMap   8
#define gGlobe      9
#define gPolar     10
#define gBiorhythm 11
#define gCalendar  12
#define gDisposit  13
#ifdef WIN
#define gAspect    14
...
#define gSwitch    23
#define gObscure   24
#define gKeystroke 25
#define gTraTraHit 26
#define gTraTraInf 27
#define gTraNatHit 28
#define gTraNatInf 29
#endif
...
#define FItem(obj)    FBetween(obj, 1, cObj)
#define FNorm(obj)    FBetween(obj, 1, oNorm)
...
#define FThing(obj)   ((obj) <= cThing || (obj) >= uranLo || (obj) == 21)
...
#define SwitchF(f) f = (((f | fOr) & !fAnd) ^ fNot)
...
#define PX(A) RCosD(A)
#define PY(A) RSinD(A)
#define PZ(A) Mod(rDegHalf-(A)+asc)
...
#define fSidebar \
  ((gi.nMode == gWheel || gi.nMode == gHouse) && gs.fText && !us.fVelocity)
...
#define fDrawText \
  ...
  ((gi.nMode != gWheel && gi.nMode != gHouse) || us.fVelocity))
#endif /* GRAPH */
...
typedef struct _InternalSettings {
  ...
  char *szFile;       /* The input chart filename string as passed to -i.  */
  char *szFile2;      /* The second chart filename string as passed to -r. */
...
typedef struct _ChartPositions {
  ...
  int navamsa[objMax]; /* For Navamsam Logan */
} CP;
...
#ifdef WIN
#define nScrollDiv 12
#define nScrollPage 3
...
typedef struct _WindowInternal {
  ...
  short yScroll;
  short cxClient; /* Horizontal & vertical window size. */
  short cyClient;
